// todo Провести полный рефакторинг
// scales the image by (float) scale < 1
// returns a canvas containing the scaled image.
function downScaleImage(img, scale, height, width, left, top) { // todo Выяснить, нужны ли height и width
...
function downScaleCanvas(cv, scale) {
  ...
  var imgRes = resCtx.getImageData(3, 3, tw, th);
  ...
  // todo Удалить
  // const div = document.querySelector('.photo-editor-result');
  
  // resCV.style.width = '5000px';
  // div.append(resCV);
